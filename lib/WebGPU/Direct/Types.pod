...
=item * sType (L<WGPUSType|WebGPU::Direct::Constants/WGPUSType>)
...
=item * adapterType (L<WGPUAdapterType|WebGPU::Direct::Constants/WGPUAdapterType>)

=item * backendType (L<WGPUBackendType|WebGPU::Direct::Constants/WGPUBackendType>)
...
=item * operation (L<WGPUBlendOperation|WebGPU::Direct::Constants/WGPUBlendOperation>)

=item * srcFactor (L<WGPUBlendFactor|WebGPU::Direct::Constants/WGPUBlendFactor>)

=item * dstFactor (L<WGPUBlendFactor|WebGPU::Direct::Constants/WGPUBlendFactor>)
...
=item * type (L<WGPUBufferBindingType|WebGPU::Direct::Constants/WGPUBufferBindingType>)
...
=item * type (L<WGPUCompilationMessageType|WebGPU::Direct::Constants/WGPUCompilationMessageType>)
...
=item * topology (L<WGPUPrimitiveTopology|WebGPU::Direct::Constants/WGPUPrimitiveTopology>)

=item * stripIndexFormat (L<WGPUIndexFormat|WebGPU::Direct::Constants/WGPUIndexFormat>)

=item * frontFace (L<WGPUFrontFace|WebGPU::Direct::Constants/WGPUFrontFace>)

=item * cullMode (L<WGPUCullMode|WebGPU::Direct::Constants/WGPUCullMode>)
...
=item * type (L<WGPUQueryType|WebGPU::Direct::Constants/WGPUQueryType>)
...
=item * colorFormats (L<WGPUTextureFormat|WebGPU::Direct::Constants/WGPUTextureFormat>)

=item * depthStencilFormat (L<WGPUTextureFormat|WebGPU::Direct::Constants/WGPUTextureFormat>)
...
=item * depthLoadOp (L<WGPULoadOp|WebGPU::Direct::Constants/WGPULoadOp>)

=item * depthStoreOp (L<WGPUStoreOp|WebGPU::Direct::Constants/WGPUStoreOp>)

=item * depthClearValue (float)

=item * depthReadOnly (WGPUBool)

=item * stencilLoadOp (L<WGPULoadOp|WebGPU::Direct::Constants/WGPULoadOp>)

=item * stencilStoreOp (L<WGPUStoreOp|WebGPU::Direct::Constants/WGPUStoreOp>)
...
=item * powerPreference (L<WGPUPowerPreference|WebGPU::Direct::Constants/WGPUPowerPreference>)
...
=item * type (L<WGPUSamplerBindingType|WebGPU::Direct::Constants/WGPUSamplerBindingType>)
...
=item * addressModeU (L<WGPUAddressMode|WebGPU::Direct::Constants/WGPUAddressMode>)

=item * addressModeV (L<WGPUAddressMode|WebGPU::Direct::Constants/WGPUAddressMode>)

=item * addressModeW (L<WGPUAddressMode|WebGPU::Direct::Constants/WGPUAddressMode>)

=item * magFilter (L<WGPUFilterMode|WebGPU::Direct::Constants/WGPUFilterMode>)

=item * minFilter (L<WGPUFilterMode|WebGPU::Direct::Constants/WGPUFilterMode>)

=item * mipmapFilter (L<WGPUMipmapFilterMode|WebGPU::Direct::Constants/WGPUMipmapFilterMode>)

=item * lodMinClamp (float)

=item * lodMaxClamp (float)

=item * compare (L<WGPUCompareFunction|WebGPU::Direct::Constants/WGPUCompareFunction>)
...
=item * failOp (L<WGPUStencilOperation|WebGPU::Direct::Constants/WGPUStencilOperation>)

=item * depthFailOp (L<WGPUStencilOperation|WebGPU::Direct::Constants/WGPUStencilOperation>)

=item * passOp (L<WGPUStencilOperation|WebGPU::Direct::Constants/WGPUStencilOperation>)
...
=item * access (L<WGPUStorageTextureAccess|WebGPU::Direct::Constants/WGPUStorageTextureAccess>)

=item * format (L<WGPUTextureFormat|WebGPU::Direct::Constants/WGPUTextureFormat>)

=item * viewDimension (L<WGPUTextureViewDimension|WebGPU::Direct::Constants/WGPUTextureViewDimension>)
...
=item * formats (L<WGPUTextureFormat|WebGPU::Direct::Constants/WGPUTextureFormat>)

=item * presentModeCount (size_t)

=item * presentModes (L<WGPUPresentMode|WebGPU::Direct::Constants/WGPUPresentMode>)

=item * alphaModeCount (size_t)

=item * alphaModes (L<WGPUCompositeAlphaMode|WebGPU::Direct::Constants/WGPUCompositeAlphaMode>)
...
=item * viewFormats (L<WGPUTextureFormat|WebGPU::Direct::Constants/WGPUTextureFormat>)

=item * alphaMode (L<WGPUCompositeAlphaMode|WebGPU::Direct::Constants/WGPUCompositeAlphaMode>)

=item * width (uint32_t)

=item * height (uint32_t)

=item * presentMode (L<WGPUPresentMode|WebGPU::Direct::Constants/WGPUPresentMode>)
...
=item * status (L<WGPUSurfaceGetCurrentTextureStatus|WebGPU::Direct::Constants/WGPUSurfaceGetCurrentTextureStatus>)
...
=item * sampleType (L<WGPUTextureSampleType|WebGPU::Direct::Constants/WGPUTextureSampleType>)
...
=item * dimension (L<WGPUTextureViewDimension|WebGPU::Direct::Constants/WGPUTextureViewDimension>)
...
=item * aspect (L<WGPUTextureAspect|WebGPU::Direct::Constants/WGPUTextureAspect>)
...
=item * format (L<WGPUVertexFormat|WebGPU::Direct::Constants/WGPUVertexFormat>)
...
=item * depthCompare (L<WGPUCompareFunction|WebGPU::Direct::Constants/WGPUCompareFunction>)
...
=item * loadOp (L<WGPULoadOp|WebGPU::Direct::Constants/WGPULoadOp>)

=item * storeOp (L<WGPUStoreOp|WebGPU::Direct::Constants/WGPUStoreOp>)
...
=item * dimension (L<WGPUTextureDimension|WebGPU::Direct::Constants/WGPUTextureDimension>)
...
=item * stepMode (L<WGPUVertexStepMode|WebGPU::Direct::Constants/WGPUVertexStepMode>)
...
=item * requiredFeatures (L<WGPUFeatureName|WebGPU::Direct::Constants/WGPUFeatureName>)
