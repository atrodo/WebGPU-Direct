...
void WebGPU__Direct__ChainedStruct__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "next", 4, &n->next , newSVpvs("WebGPU::Direct::ChainedStruct"));
...
void WebGPU__Direct__ChainedStructOut__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "next", 4, &n->next , newSVpvs("WebGPU::Direct::ChainedStructOut"));
  _unpack_enum(aTHX_ h, "sType", 5, &n->sType );
...
void WebGPU__Direct__AdapterProperties__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStructOut"));
...
void WebGPU__Direct__BindGroupEntry__pack( SV *THIS )
{
  ...
  _find_set_void(aTHX_ h, "buffer", 6, &n->buffer , newSVpvs("void *"));
  _find_set_uint64_t(aTHX_ h, "offset", 6, &n->offset );
  _find_set_uint64_t(aTHX_ h, "size", 4, &n->size );
  _find_set_void(aTHX_ h, "sampler", 7, &n->sampler , newSVpvs("void *"));
  _find_set_void(aTHX_ h, "textureView", 11, &n->textureView , newSVpvs("void *"));
...
void WebGPU__Direct__BindGroupEntry__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_uint32_t(aTHX_ h, "binding", 7, &n->binding );
  _unpack_void(aTHX_ h, "buffer", 6, &n->buffer , newSVpvs("void *"));
  _unpack_uint64_t(aTHX_ h, "offset", 6, &n->offset );
  _unpack_uint64_t(aTHX_ h, "size", 4, &n->size );
  _unpack_void(aTHX_ h, "sampler", 7, &n->sampler , newSVpvs("void *"));
  _unpack_void(aTHX_ h, "textureView", 11, &n->textureView , newSVpvs("void *"));
...
void WebGPU__Direct__ComputePassTimestampWrite__pack( SV *THIS )
{
  ...
  SV **f;
  SV *fp;
  _find_set_void(aTHX_ h, "querySet", 8, &n->querySet , newSVpvs("void *"));
...
void WebGPU__Direct__ComputePassTimestampWrite__unpack( SV *THIS )
{
  ...
  _unpack_void(aTHX_ h, "querySet", 8, &n->querySet , newSVpvs("void *"));
...
void WebGPU__Direct__PipelineLayoutDescriptor__pack( SV *THIS )
{
  ...
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_str(aTHX_ h, "label", 5, &n->label );
  _find_set_uint32_t(aTHX_ h, "bindGroupLayoutCount", 20, &n->bindGroupLayoutCount );
  _find_set_void(aTHX_ h, "bindGroupLayouts", 16, &n->bindGroupLayouts , newSVpvs("void *"));
...
void WebGPU__Direct__PipelineLayoutDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_str(aTHX_ h, "label", 5, &n->label );
  _unpack_uint32_t(aTHX_ h, "bindGroupLayoutCount", 20, &n->bindGroupLayoutCount );
  _unpack_void(aTHX_ h, "bindGroupLayouts", 16, &n->bindGroupLayouts , newSVpvs("void *"));
...
void WebGPU__Direct__QuerySetDescriptor__pack( SV *THIS )
{
  ...
  _find_set_enum(aTHX_ h, "type", 4, &n->type );
  _find_set_uint32_t(aTHX_ h, "count", 5, &n->count );
  // "pipelineStatistics" is a ptr, and that's not quite right yet
  _find_set_uint32_t(aTHX_ h, "pipelineStatisticsCount", 23, &n->pipelineStatisticsCount );
...
void WebGPU__Direct__QuerySetDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_uint32_t(aTHX_ h, "count", 5, &n->count );
  // "pipelineStatistics" is a ptr, and that's not quite right yet
  _unpack_uint32_t(aTHX_ h, "pipelineStatisticsCount", 23, &n->pipelineStatisticsCount );
...
void WebGPU__Direct__RenderBundleEncoderDescriptor__pack( SV *THIS )
{
  ...
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_str(aTHX_ h, "label", 5, &n->label );
  _find_set_uint32_t(aTHX_ h, "colorFormatsCount", 17, &n->colorFormatsCount );
  // "colorFormats" is a ptr, and that's not quite right yet
...
void WebGPU__Direct__RenderBundleEncoderDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_str(aTHX_ h, "label", 5, &n->label );
  _unpack_uint32_t(aTHX_ h, "colorFormatsCount", 17, &n->colorFormatsCount );
  // "colorFormats" is a ptr, and that's not quite right yet
...
void WebGPU__Direct__RenderPassDepthStencilAttachment__pack( SV *THIS )
{
  ...
  SV **f;
  SV *fp;
  _find_set_void(aTHX_ h, "view", 4, &n->view , newSVpvs("void *"));
...
void WebGPU__Direct__RenderPassDepthStencilAttachment__unpack( SV *THIS )
{
  ...
  _unpack_void(aTHX_ h, "view", 4, &n->view , newSVpvs("void *"));
...
void WebGPU__Direct__RequestAdapterOptions__pack( SV *THIS )
{
  ...
  SV *fp;
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_void(aTHX_ h, "compatibleSurface", 17, &n->compatibleSurface , newSVpvs("void *"));
...
void WebGPU__Direct__RequestAdapterOptions__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "compatibleSurface", 17, &n->compatibleSurface , newSVpvs("void *"));
...
void WebGPU__Direct__ShaderModuleCompilationHint__pack( SV *THIS )
{
  ...
  _find_set_void(aTHX_ h, "layout", 6, &n->layout , newSVpvs("void *"));
...
void WebGPU__Direct__ShaderModuleCompilationHint__unpack( SV *THIS )
{
  ...
  _unpack_void(aTHX_ h, "layout", 6, &n->layout , newSVpvs("void *"));
...
void WebGPU__Direct__ShaderModuleSPIRVDescriptor__pack( SV *THIS )
{
  ...
  // "code" is a ptr, and that's not quite right yet
...
void WebGPU__Direct__SurfaceDescriptorFromAndroidNativeWindow__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "chain", 5, &n->chain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "window", 6, &n->window , newSVpvs("void *"));
...
void WebGPU__Direct__SurfaceDescriptorFromMetalLayer__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "chain", 5, &n->chain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "layer", 5, &n->layer , newSVpvs("void *"));
...
void WebGPU__Direct__SurfaceDescriptorFromWaylandSurface__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "chain", 5, &n->chain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "display", 7, &n->display , newSVpvs("void *"));
  _unpack_void(aTHX_ h, "surface", 7, &n->surface , newSVpvs("void *"));
...
void WebGPU__Direct__SurfaceDescriptorFromWindowsHWND__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "chain", 5, &n->chain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "hinstance", 9, &n->hinstance , newSVpvs("void *"));
  _unpack_void(aTHX_ h, "hwnd", 4, &n->hwnd , newSVpvs("void *"));
...
void WebGPU__Direct__SurfaceDescriptorFromXcbWindow__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "chain", 5, &n->chain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "connection", 10, &n->connection , newSVpvs("void *"));
...
void WebGPU__Direct__BindGroupDescriptor__pack( SV *THIS )
{
  ...
  _find_set_str(aTHX_ h, "label", 5, &n->label );
  _find_set_void(aTHX_ h, "layout", 6, &n->layout , newSVpvs("void *"));
  _find_set_uint32_t(aTHX_ h, "entryCount", 10, &n->entryCount );
...
void WebGPU__Direct__BindGroupDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "entries", 7, &n->entries , newSVpvs("WebGPU::Direct::BindGroupEntry"));
...
void WebGPU__Direct__CompilationInfo__pack( SV *THIS )
{
  ...
  SV *fp;
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_uint32_t(aTHX_ h, "messageCount", 12, &n->messageCount );
...
void WebGPU__Direct__CompilationInfo__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_uint32_t(aTHX_ h, "messageCount", 12, &n->messageCount );
  _unpack_obj(aTHX_ h, "messages", 8, &n->messages , newSVpvs("WebGPU::Direct::CompilationMessage"));
...
void WebGPU__Direct__ComputePassDescriptor__pack( SV *THIS )
{
  ...
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_str(aTHX_ h, "label", 5, &n->label );
  _find_set_uint32_t(aTHX_ h, "timestampWriteCount", 19, &n->timestampWriteCount );
...
void WebGPU__Direct__ComputePassDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "timestampWrites", 15, &n->timestampWrites , newSVpvs("WebGPU::Direct::ComputePassTimestampWrite"));
...
void WebGPU__Direct__ImageCopyTexture__pack( SV *THIS )
{
  ...
  SV *fp;
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_void(aTHX_ h, "texture", 7, &n->texture , newSVpvs("void *"));
...
void WebGPU__Direct__ImageCopyTexture__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "texture", 7, &n->texture , newSVpvs("void *"));
...
void WebGPU__Direct__ProgrammableStageDescriptor__pack( SV *THIS )
{
  ...
  SV *fp;
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_void(aTHX_ h, "module", 6, &n->module , newSVpvs("void *"));
  _find_set_str(aTHX_ h, "entryPoint", 10, &n->entryPoint );
  _find_set_uint32_t(aTHX_ h, "constantCount", 13, &n->constantCount );
...
void WebGPU__Direct__ProgrammableStageDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_void(aTHX_ h, "module", 6, &n->module , newSVpvs("void *"));
  _unpack_str(aTHX_ h, "entryPoint", 10, &n->entryPoint );
  _unpack_uint32_t(aTHX_ h, "constantCount", 13, &n->constantCount );
  _unpack_obj(aTHX_ h, "constants", 9, &n->constants , newSVpvs("WebGPU::Direct::ConstantEntry"));
...
void WebGPU__Direct__RenderPassColorAttachment__pack( SV *THIS )
{
  ...
  SV *fp;
  _find_set_void(aTHX_ h, "view", 4, &n->view , newSVpvs("void *"));
  _find_set_void(aTHX_ h, "resolveTarget", 13, &n->resolveTarget , newSVpvs("void *"));
...
void WebGPU__Direct__RenderPassColorAttachment__unpack( SV *THIS )
{
  ...
  _unpack_void(aTHX_ h, "view", 4, &n->view , newSVpvs("void *"));
  _unpack_void(aTHX_ h, "resolveTarget", 13, &n->resolveTarget , newSVpvs("void *"));
...
void WebGPU__Direct__ShaderModuleDescriptor__pack( SV *THIS )
{
  ...
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_str(aTHX_ h, "label", 5, &n->label );
  _find_set_uint32_t(aTHX_ h, "hintCount", 9, &n->hintCount );
...
void WebGPU__Direct__ShaderModuleDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_str(aTHX_ h, "label", 5, &n->label );
  _unpack_uint32_t(aTHX_ h, "hintCount", 9, &n->hintCount );
  _unpack_obj(aTHX_ h, "hints", 5, &n->hints , newSVpvs("WebGPU::Direct::ShaderModuleCompilationHint"));
...
void WebGPU__Direct__TextureDescriptor__pack( SV *THIS )
{
  ...
  _find_set_uint32_t(aTHX_ h, "mipLevelCount", 13, &n->mipLevelCount );
  _find_set_uint32_t(aTHX_ h, "sampleCount", 11, &n->sampleCount );
  _find_set_uint32_t(aTHX_ h, "viewFormatCount", 15, &n->viewFormatCount );
  // "viewFormats" is a ptr, and that's not quite right yet
...
void WebGPU__Direct__TextureDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_uint32_t(aTHX_ h, "mipLevelCount", 13, &n->mipLevelCount );
  _unpack_uint32_t(aTHX_ h, "sampleCount", 11, &n->sampleCount );
  _unpack_uint32_t(aTHX_ h, "viewFormatCount", 15, &n->viewFormatCount );
  // "viewFormats" is a ptr, and that's not quite right yet
...
void WebGPU__Direct__VertexBufferLayout__pack( SV *THIS )
{
  ...
  _find_set_uint32_t(aTHX_ h, "attributeCount", 14, &n->attributeCount );
...
void WebGPU__Direct__VertexBufferLayout__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "attributes", 10, &n->attributes , newSVpvs("WebGPU::Direct::VertexAttribute"));
...
void WebGPU__Direct__BindGroupLayoutDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_str(aTHX_ h, "label", 5, &n->label );
  _unpack_uint32_t(aTHX_ h, "entryCount", 10, &n->entryCount );
  _unpack_obj(aTHX_ h, "entries", 7, &n->entries , newSVpvs("WebGPU::Direct::BindGroupLayoutEntry"));
...
void WebGPU__Direct__ColorTargetState__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_enum(aTHX_ h, "format", 6, &n->format );
  _unpack_obj(aTHX_ h, "blend", 5, &n->blend , newSVpvs("WebGPU::Direct::BlendState"));
...
void WebGPU__Direct__DeviceDescriptor__pack( SV *THIS )
{
  ...
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_str(aTHX_ h, "label", 5, &n->label );
  _find_set_uint32_t(aTHX_ h, "requiredFeaturesCount", 21, &n->requiredFeaturesCount );
  // "requiredFeatures" is a ptr, and that's not quite right yet
...
void WebGPU__Direct__DeviceDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_str(aTHX_ h, "label", 5, &n->label );
  _unpack_uint32_t(aTHX_ h, "requiredFeaturesCount", 21, &n->requiredFeaturesCount );
  // "requiredFeatures" is a ptr, and that's not quite right yet
  _unpack_obj(aTHX_ h, "requiredLimits", 14, &n->requiredLimits , newSVpvs("WebGPU::Direct::RequiredLimits"));
...
void WebGPU__Direct__RenderPassDescriptor__pack( SV *THIS )
{
  ...
  _find_set_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _find_set_str(aTHX_ h, "label", 5, &n->label );
  _find_set_uint32_t(aTHX_ h, "colorAttachmentCount", 20, &n->colorAttachmentCount );
  ...
  _find_set_void(aTHX_ h, "occlusionQuerySet", 17, &n->occlusionQuerySet , newSVpvs("void *"));
  _find_set_uint32_t(aTHX_ h, "timestampWriteCount", 19, &n->timestampWriteCount );
...
void WebGPU__Direct__RenderPassDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "nextInChain", 11, &n->nextInChain , newSVpvs("WebGPU::Direct::ChainedStruct"));
  _unpack_str(aTHX_ h, "label", 5, &n->label );
  _unpack_uint32_t(aTHX_ h, "colorAttachmentCount", 20, &n->colorAttachmentCount );
  _unpack_obj(aTHX_ h, "colorAttachments", 16, &n->colorAttachments , newSVpvs("WebGPU::Direct::RenderPassColorAttachment"));
  _unpack_obj(aTHX_ h, "depthStencilAttachment", 22, &n->depthStencilAttachment , newSVpvs("WebGPU::Direct::RenderPassDepthStencilAttachment"));
  _unpack_void(aTHX_ h, "occlusionQuerySet", 17, &n->occlusionQuerySet , newSVpvs("void *"));
  _unpack_uint32_t(aTHX_ h, "timestampWriteCount", 19, &n->timestampWriteCount );
  _unpack_obj(aTHX_ h, "timestampWrites", 15, &n->timestampWrites , newSVpvs("WebGPU::Direct::RenderPassTimestampWrite"));
...
void WebGPU__Direct__VertexState__pack( SV *THIS )
{
  ...
  _find_set_uint32_t(aTHX_ h, "constantCount", 13, &n->constantCount );
  _find_set_obj(aTHX_ h, "constants", 9, &n->constants , newSVpvs("WebGPU::Direct::ConstantEntry"));
  _find_set_uint32_t(aTHX_ h, "bufferCount", 11, &n->bufferCount );
...
void WebGPU__Direct__VertexState__unpack( SV *THIS )
{
  ...
  _unpack_uint32_t(aTHX_ h, "constantCount", 13, &n->constantCount );
  _unpack_obj(aTHX_ h, "constants", 9, &n->constants , newSVpvs("WebGPU::Direct::ConstantEntry"));
  _unpack_uint32_t(aTHX_ h, "bufferCount", 11, &n->bufferCount );
  _unpack_obj(aTHX_ h, "buffers", 7, &n->buffers , newSVpvs("WebGPU::Direct::VertexBufferLayout"));
...
void WebGPU__Direct__FragmentState__pack( SV *THIS )
{
  ...
  _find_set_uint32_t(aTHX_ h, "constantCount", 13, &n->constantCount );
  _find_set_obj(aTHX_ h, "constants", 9, &n->constants , newSVpvs("WebGPU::Direct::ConstantEntry"));
  _find_set_uint32_t(aTHX_ h, "targetCount", 11, &n->targetCount );
...
void WebGPU__Direct__FragmentState__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "targets", 7, &n->targets , newSVpvs("WebGPU::Direct::ColorTargetState"));
...
void WebGPU__Direct__RenderPipelineDescriptor__unpack( SV *THIS )
{
  ...
  _unpack_obj(aTHX_ h, "depthStencil", 12, &n->depthStencil , newSVpvs("WebGPU::Direct::DepthStencilState"));
  _unpack_obj(aTHX_ h, "multisample", 11, &n->multisample , newSVpvs("WebGPU::Direct::MultisampleState"));
  _unpack_obj(aTHX_ h, "fragment", 8, &n->fragment , newSVpvs("WebGPU::Direct::FragmentState"));
